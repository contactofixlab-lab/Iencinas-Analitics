...
export const PROYECTOS: Project[] = [
  ...
  {
    id: 'proj-009',
    nombre: 'Lastarria Luxury Apartments',
    ubicacion: 'Lastarria, Región Metropolitana',
    estado: 'activo',
    fechaInicio: '2024-04-10',
  },
  {
    id: 'proj-010',
    nombre: 'Reñaca Beach Resort',
    ubicacion: 'Reñaca, Región de Valparaíso',
    estado: 'activo',
    fechaInicio: '2023-10-20',
  },
  {
    id: 'proj-011',
    nombre: 'San Isidro Industrial Complex',
    ubicacion: 'San Isidro, Región Metropolitana',
    estado: 'activo',
    fechaInicio: '2024-01-05',
  },
  {
    id: 'proj-012',
    nombre: 'Conchalí Community Housing',
    ubicacion: 'Conchalí, Región Metropolitana',
    estado: 'inactivo',
    fechaInicio: '2023-08-15',
  },
  {
    id: 'proj-013',
    nombre: 'Chicureo Premium Enclave',
...
export const TRANSACCIONES: Transaction[] = [
  ...
  // Lastarria Luxury Apartments
  {
    id: 'trx-028',
    proyectoId: 'proj-009',
    concepto: 'Venta Departamento Penthouse L-701',
    tipo: 'Ingreso',
    monto: 1450000,
    montoFormato: '$1,450,000',
    fecha: '2026-06-16',
    categoria: 'Ventas',
  },
  {
  ...
  // Reñaca Beach Resort
  {
    id: 'trx-030',
    proyectoId: 'proj-010',
    concepto: 'Ingresos por alojamiento',
    tipo: 'Ingreso',
    monto: 280000,
    montoFormato: '$280,000',
    fecha: '2026-06-15',
  ...
  // San Isidro Industrial Complex
  {
    id: 'trx-033',
    proyectoId: 'proj-011',
    concepto: 'Venta Bodega Industrial B-12',
    tipo: 'Ingreso',
    monto: 720000,
    montoFormato: '$720,000',
    fecha: '2026-06-12',
    categoria: 'Ventas',
  },
  {
  ...
  // Conchalí Community Housing
  {
    id: 'trx-035',
    proyectoId: 'proj-012',
    concepto: 'Estudios de factibilidad',
    tipo: 'Egreso',
    monto: 35000,
    montoFormato: '$35,000',
    fecha: '2026-06-10',
  ...
  // Chicureo Premium Enclave
  {
    id: 'trx-036',
    proyectoId: 'proj-013',
    concepto: 'Venta Casa Premium C-01',
    tipo: 'Ingreso',
    monto: 2800000,
    montoFormato: '$2,800,000',
    fecha: '2026-06-14',
    categoria: 'Ventas',
  },
  {
    id: 'trx-037',
    proyectoId: 'proj-013',
    concepto: 'Comisión ejecutiva',
    tipo: 'Egreso',
    monto: 140000,
    montoFormato: '$140,000',
    fecha: '2026-06-16',
    categoria: 'Comisiones',
  },
  {
...
export const VENTAS: Sale[] = [
  ...
  // Lastarria Luxury Apartments
  {
    id: 'sale-023',
    proyectoId: 'proj-009',
    propiedad: 'Penthouse L-701',
    etapa: 'Cerrada',
    cantidad: 1,
    valor: 1450000,
    valorFormato: '$1,450,000',
    fecha: '2026-06-16',
    clienteNombre: 'Empresario Tecnológico',
    comision: 72500,
  },
  {
    id: 'sale-024',
    proyectoId: 'proj-009',
    propiedad: 'Departamento L-405',
    etapa: 'Negociación',
    cantidad: 1,
    valor: 890000,
    valorFormato: '$890,000',
    fecha: '2026-06-20',
    clienteNombre: 'Profesional Independiente',
  },
  ...
  // Reñaca Beach Resort
  {
    id: 'sale-025',
    proyectoId: 'proj-010',
    propiedad: 'Suite Deluxe',
    etapa: 'Cerrada',
    cantidad: 2,
    valor: 280000,
    valorFormato: '$280,000',
    fecha: '2026-06-15',
    clienteNombre: 'Resort Operator',
    comision: 14000,
  },
  ...
  // San Isidro Industrial Complex
  {
    id: 'sale-026',
    proyectoId: 'proj-011',
    propiedad: 'Bodega Industrial B-12',
    etapa: 'Cerrada',
    cantidad: 1,
    valor: 720000,
    valorFormato: '$720,000',
    fecha: '2026-06-12',
    clienteNombre: 'Empresa Logística',
    comision: 36000,
  },
  {
    id: 'sale-027',
    proyectoId: 'proj-011',
    propiedad: 'Bodega Industrial B-08',
    etapa: 'Oferta',
    cantidad: 1,
    valor: 680000,
    valorFormato: '$680,000',
    fecha: '2026-06-21',
    clienteNombre: 'Distribuidor',
  },
  ...
  // Chicureo Premium Enclave
  {
    id: 'sale-028',
    proyectoId: 'proj-013',
    propiedad: 'Casa Premium C-01',
    etapa: 'Cerrada',
    cantidad: 1,
    valor: 2800000,
    valorFormato: '$2,800,000',
    fecha: '2026-06-14',
    clienteNombre: 'Familia Empresarial',
    comision: 140000,
  },
  {
    id: 'sale-029',
    proyectoId: 'proj-013',
    propiedad: 'Casa Premium C-02',
    etapa: 'Negociación',
    cantidad: 1,
    valor: 2700000,
    valorFormato: '$2,700,000',
    fecha: '2026-06-22',
    clienteNombre: 'Inversor Privado',
  },
];
...
export const LEADS: Lead[] = [
  ...
  // Lastarria Luxury Apartments
  {
    id: 'lead-024',
    proyectoId: 'proj-009',
    nombre: 'Isidora Valenzuela',
    email: 'isidora.v@email.com',
    canal: 'Web',
    costo: 250,
    costoFormato: '$250',
    estado: 'Convertido',
  ...
  },
  {
    id: 'lead-030',
    proyectoId: 'proj-013',
    nombre: 'Ódila Riquelme',
    email: 'odila.r@email.com',
    canal: 'Evento',
    costo: 1200,
    costoFormato: '$1,200',
    estado: 'En progreso',
...
export const VALUACIONES: Valuation[] = [
  ...
  },
  {
    ...
    anio: 2025,
    valor: 9900800,
    valorFormato: '$9,900,800',
    crecimiento: 12.5,
    crecimientoFormato: '12.5%',
    fecha: '2025-12-31',
    metodologia: 'DCF',
  },
  {
